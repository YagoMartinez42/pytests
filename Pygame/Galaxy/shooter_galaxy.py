...
while run:
   ...
   for e in event.get():
       ...
       #evento para presionar barra espaciadora – el objeto dispara
           ...
           if e.key == K_SPACE:
                   ...
                   if num_fire  >= 10 and rel_time == False : #si el jugador hizo 5 disparos
   ...
   if not finish:
       ...
       if rel_time == True:
           ...
           if now_time - last_time < 2: #antes de que terminen los 3 segundos, mostrar el mensaje de recarga
